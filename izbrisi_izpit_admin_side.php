<?php
  ...
  $sql=$db->query("SELECT * FROM izpit ");
  $sql->execute();
...
<br><br><br><br><br><br><br><br><br><br>
    ...
    ?>
        <tr style="font-size:16px"><td><?php echo $izpit->IME ?></td><td><?php echo $izpit->CENA ?>&euro;</td><td><?php echo $izpit->IZVAJALEC?></td><td><?php echo $izpit->PROSTORIJA?></td><td><?php echo $izpit->DATUM ?></td><td><button type="submit" name='id' value='<?php echo $izpit->ID ?>'>Izbrisi</button></td></tr>
   <?php endforeach
    ?>
   </table>
...
<footer>
    <p>Vec informacij:sistemIzpite@outlook.com</p>
