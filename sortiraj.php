...
if(isset($_GET['izvajalec'])){

   // echo $_GET['izvajalec'];

    $izvajalecSort=trim(strtolower($_GET['izvajalec']));

    $sql=$db->query("SELECT izpit.ID,izpit.IME,izpit.CENA
         FROM izpit  
         LEFT JOIN zaporeden_pristop
         ON izpit.ID=zaporeden_pristop.izpit
         WHERE IZVAJALEC='".$izvajalecSort."'
         GROUP BY izpit.ID
         ");
...
<header>
    ...
    <ul>
        ...
        <?php endif ?>
        <?php if(isset($_SESSION['success_admin'])): ?>
            <li><a href="izbrisi_film_admin_side.php">Izbrisi Film</a></li>
        <?php endif ?>
        ...
        <li style="font-size:17px"><a> <?php if(isset($_SESSION['success_admin'])){
                ...
                ?></a></li>
        <!--    <div class="input"><li><input type="text" name="search" placeholder="search..."></li></div> --->
        <ul>
</header>
<br><br><br><br><br>
<br><br>
...
<div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
    ...
    <div class="w3-row-padding w3-padding-16 w3-center" id="food">
        ...
        foreach ($izpiti as $izpit):
            ...
            ?>
            <form action="VeciInfoFilm.php?ID=<?php echo $izpit->ID ?>" method="get" enctype="multipart/form-data">
